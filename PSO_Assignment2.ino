...
char ssid[] = "TP-LINK_37C598";     //  your network SSID (name)
char pass[] = "25729559";  // your network password
...
const String CLIENT_ID = "223113982225-rftg93el7j3i3er0h1o4kiboemkch03n.apps.googleusercontent.com  ";

// the clientSecret found in Google's Developer Console under APIs & Auth > Credentials
const String CLIENT_SECRET = "qc_gbMBZbqqr-saPOmCyclor";

// returned after running FinalizeOAuth
const String REFRESH_TOKEN = "1/WIpFPAi3hG0oNz7ArsNxBhD5v4f6KCY8xKyefwxseRI";
...
// as described above.)
const String SPREADSHEET_TITLE = "PSO_Assignment";

const unsigned long RUN_INTERVAL_MILLIS = 5000; // how often to run the Choreo (in milliseconds)

// the last time we ran the Choreo 
// (initialized to 60 seconds ago so the
// Choreo is run immediately when we start up)
unsigned long lastRun = (unsigned long)-5000;
